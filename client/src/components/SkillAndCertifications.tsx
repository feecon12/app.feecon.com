...
const Card: React.FC<CardProps> = ({ img, verifyLink }) => {
  return (
    <>
      <div className="flex flex-col items-center justify-between">
        <motion.div
          className="w-[200px] shadow-xl border m-2 p-3 flex flex-col items-center justify-center dark:shadow-lg dark:shadow-slate-50 dark:rounded-lg rounded-lg flex-shrink-0"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
...
const CertificationList = () => {
  return (
    <div className="flex">
      <Card
        verifyLink={
          "https://www.credly.com/badges/b3d8247d-2b8e-46f2-9adb-fd0ed9be79ed/"
        }
        img={AwsCert}
      />
      <Card
        verifyLink={
          "https://learn.microsoft.com/api/credentials/share/en-us/FeeconBehera-2966/5B8137F8C7E1D33?sharingId=7538A1A860DF4211"
        }
        img={MsAzure}
      />
      <Card
